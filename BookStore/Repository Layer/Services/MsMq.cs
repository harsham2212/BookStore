...
namespace Repository_Layer.Services
{
    public class MsMq
    {
        ...
        private void Msmq_ReceiveCompleted(object sender, ReceiveCompletedEventArgs e)
        {
            ...
            MailMessage message = new MailMessage("duser9127@gmail.com", mailReceiver);
            ...
            System.Net.NetworkCredential basicCredential1 = new System.Net.NetworkCredential("duser9127@gmail.com", "123456@user");//vallid email and password
